...
export default function EditTaskModal({ data, taskId } : EditTaskModalProps) {
    ...
    //instanciamos queryClient para recargar cache
    ...
    //React Query --> realizamos un mutate para enviar datos
    ...
    //importamos navigate para redireccionar cuando cerremos modal
